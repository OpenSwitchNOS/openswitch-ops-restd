...
class AccountController(BaseController):
    ...
    def __encrypt_password_server_message__(self, username, current_password,
        ...
        try:
            ...
            raise PasswordChangeError("Password change failed.")
    ...
    def __change_user_password__(self, username, current_password,
        ...
        try:
            ...
            # TODO change this to a non-blocking call and add a timeout
            ...
            raise PasswordChangeError("Password change failed, please " +
                                      "try again later.")
        finally:
            sock.close()
