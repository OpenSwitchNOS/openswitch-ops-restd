...
class AccountController(BaseController):
    ...
    def initialize(self):
        ...
        passwd_srv_obj = PasswordServerConfig()
        self.passwd_srv_sock_fd = passwd_srv_obj.passwd_srv_sock_fd
        self.passwd_srv_pub_key_loc = passwd_srv_obj.passwd_srv_pub_key_loc
    ...
    def __connect_to_password_server__(self):
        ...
        try:
            ...
            sock.connect(self.passwd_srv_sock_fd)
    ...
    def __encrypt_password_server_message__(self, username, current_password,
        ...
        try:
            ...
            with open(self.passwd_srv_pub_key_loc, 'r') as pub_key_file:
