...
from .constants import SUBSCRIBER_TABLE


def is_resource_modified(row_track_info, idl):
    return row_track_info.update_seqno >= idl.change_seqno


def is_resource_added(row_track_info, idl):
    return row_track_info.create_seqno >= idl.change_seqno


def is_resource_deleted(row_track_info, idl):
    return row_track_info.delete_seqno >= idl.change_seqno
