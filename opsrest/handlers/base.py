...
class BaseHandler(web.RequestHandler):
    ...
    def check_method_permission(self):
        ...
        # Map HTTP methods to RBAC permissions
        method_to_permission = {}
        method_to_permission[REQUEST_TYPE_READ] = rbac.READ_SWITCH_CONFIG
        method_to_permission[REQUEST_TYPE_CREATE] = rbac.WRITE_SWITCH_CONFIG
        method_to_permission[REQUEST_TYPE_UPDATE] = rbac.WRITE_SWITCH_CONFIG
        method_to_permission[REQUEST_TYPE_DELETE] = rbac.WRITE_SWITCH_CONFIG
        method_to_permission[REQUEST_TYPE_PATCH] = rbac.WRITE_SWITCH_CONFIG
        ...
        if settings['auth_enabled'] and method != REQUEST_TYPE_OPTIONS:
            ...
            if method_to_permission[method] not in permissions:
