...
def get_row_json(row, table, schema, idl, uri, selector=None,
    ...
    keys = {}
    keys[OVSDB_SCHEMA_CONFIG] = schema_table.config
    keys[OVSDB_SCHEMA_STATS] = schema_table.stats
    keys[OVSDB_SCHEMA_STATUS] = schema_table.status
    keys[OVSDB_SCHEMA_REFERENCE] = schema_table.references

    if schema_table.dynamic:
