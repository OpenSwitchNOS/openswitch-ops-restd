...
def test_restd_ct_ovsdb_conn_stop_ovsdb_server(setup, sanity_check,
                                               topology, step):
...
def test_restd_ct_ovsdb_conn_stop_start_ovsdb_server(setup, sanity_check,
                                                     topology, step):
...
def test_restd_ct_ovsdb_conn_stop_ovsdb_server_start_stop_restd(
...
def test_restd_ct_ovsdb_conn_stop_start_server_stop_start_restd(
        setup, sanity_check, topology, step):
