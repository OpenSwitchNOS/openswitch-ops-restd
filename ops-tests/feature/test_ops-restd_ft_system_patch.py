...
def test_patch_add_new_value_with_invalid_etag(setup, setup_module,
                                               topology, step):
    # Test Setup
...
def test_patch_add_an_empty_optional_member(setup, setup_module,
                                            topology, step):
    # Test Setup
...
def test_patch_add_value_with_malformed_patch(setup, setup_module,
                                              topology, step):
    # Test Setup
...
def test_patch_add_new_value_for_boolean_field(setup, setup_module,
                                               topology, step):
    # Test Setup
...
def test_patch_test_operation_nonexistent_value(setup, setup_module,
                                                topology, step):
    # Test Setup
...
def test_patch_test_operation_for_existent_value(setup, setup_module,
                                                 topology, step):
    # Test Setup
