...
class QueryFilterPortTest():
    ...
    def skip_port_filter_by_trunks(self):
        global PATH
    ...
    def skip_port_filter_by_tag(self):
        global PATH
        ports = ["Port-1", "Port-2", "Port-3", "Port-4", "Port-5"]
        field = "tag"
        old_value = 654
    ...
    def skip_port_filter_by_vlan_mode(self):
        global PATH
        ports = ["Port-1", "Port-2", "Port-3"]
        field = "vlan_mode"
        old_value = "trunk"
    ...
    def port_filter_by_ipv6_address(self):
        ...
        for i in range(1, NUM_FAKE_PORTS + 1):
            ip6 = "2001:0db8:85a3:0000:0000:8a2e:0370:%04d/64" % i
    ...
    def port_filter_by_ipv6_address_secondary(self):
        ...
        for i in range(1, NUM_FAKE_PORTS + 1):
            secondary_ip6 = "2001:0db8:85a3:0000:0000:8a2e:0371:%04d/64" % i
