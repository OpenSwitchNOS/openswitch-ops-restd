#!/usr/bin/env python
#
# Copyright (C) 2015-2016 Hewlett Packard Enterprise Developmen
# All Rights Reserved.
#
...
class QueryBGPRoutersTest (OpsVsiTest):
    ...
    def verify_get_bgp_neighbors(self):
        ...
        info('\nGET for BGP neighbors with asn: ' +
             str(_DATA['configuration']['asn']) + ' passed successfuly\n')
    ...
    def verify_post_bgp_neighbors(self):
        ...
        info('\nPOST BGP neighbors with the ip: ' + str(_DATA_BGP_NEIGHBORS
             ['configuration']['ip_or_group_name']) + ' passed successfuly\n')
        ...
        info('Post test passed successfuly')
    ...
    def verify_delete_bgp_neighbors(self):
        ...
        info('DELETE passed successfuly')
        info("\n")
