...
class systemTest(HalonTest):
    ...
    def call_system_get(self, switch_ip):
        ...
        conn.request("GET", path, json.dumps(""), headers)
    ...
    def call_system_options(self, switch_ip):
        ...
        headers = {"Content-type": "application/json", "Accept": "text/plain"}
        conn = httplib.HTTPConnection(switch_ip, 8091)
        conn.request("OPTIONS", path, json.dumps(""), headers)
        response = conn.getresponse()
    ...
    def call_system_put(self, switch_ip):
        ...
        pre_put_json_string = response.read()
        pre_put_get_data = {}
        ...
        conn = httplib.HTTPConnection(switch_ip, 8091)
        conn.request("PUT", path, json.dumps({'configuration': put_data}), headers)
        response = conn.getresponse()
        ...
        post_put_json_string = response.read()
        post_put_get_data = {}
        ...
        conn = httplib.HTTPConnection(switch_ip, 8091)
        conn.request("PUT", path, json_string, headers)
        response = conn.getresponse()
